...
#This analysis includes multivariate ordinal and statistical analyses of macropod fourth metatarsals and models the classification of archaeological specimens from Boodie Cave, Western Australia.
...
setwd("~/Dropbox/Documents/PhD/Metric_Morphometrics/Metric_morph_R/Morphometric_classification_kangaroo_bones/MetatarsalIV")
```
...
remove(Allom.Mfuliginosus, Allom.Nagilis, Allom.Orobustus, Allom.Orufus, LargeMacrpd, Mfuliginosus, Nagilis, Ontogeny, Ontogeny.LargeGenus, Ontogeny.Mfuliginosus, Ontogeny.Nagilis, Ontogeny.Orobustus, Ontogeny.Orufus, Ontogeny.Osphranter, Orobustus, Orufus, Osphranter, Sex.Mfuliginosus, Shape.OrobSubsp, den, Fcritical, num, QF)
```
...
```{r Table S6-S8 Multivariate analysis of variance on macropod fourth metatarsal shape}
write.csv(Large.Macropod.Manovas, "Supp_Tables/Table.S6C.csv")
write.csv(Medium.Macropod.Manovas, "Supp_Tables/Table.S7C.csv")
write.csv(Small.Macropod.Manovas, "Supp_Tables/Table.S8C.csv")
```
